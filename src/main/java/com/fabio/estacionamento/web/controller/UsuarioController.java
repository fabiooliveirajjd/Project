...
import com.fabio.estacionamento.web.dto.UsuarioSenhaDto;
import com.fabio.estacionamento.web.dto.mapper.UsuarioMapper;
...
public class UsuarioController {
    ...
    @PatchMapping("/{id}") // Método para atualizar a senha de um usuário
