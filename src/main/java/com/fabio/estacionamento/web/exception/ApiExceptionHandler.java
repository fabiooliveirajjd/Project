...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> passwordInvalidException(RuntimeException ex, HttpServletRequest request) {
        ...
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST) // define o status da resposta
                .contentType(MediaType.APPLICATION_JSON) // define o tipo de conteúdo da resposta
                .body(new ErrorMessage(request, HttpStatus.BAD_REQUEST, ex.getMessage())); // define o corpo da resposta
    }
