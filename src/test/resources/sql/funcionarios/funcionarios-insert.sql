...
insert into FUNCIONARIOS (id, nome, cpf, id_usuario) values (10, 'Bianca Silva', '79074426050', 101);
insert into FUNCIONARIOS (id, nome, cpf, id_usuario) values (20, 'Roberto Gomes', '55352517047', 102);